...
interface ReadinessReport extends LivenessReport {
   ...
   * this service does not call any backing service yet, and reporting a
   * dependency that is never probed would make readiness lie.
   */
  checks: string[];
}
...
export class HealthController {
  constructor(@Inject(APP_ENV) private readonly env: WebBffEnv) {}
