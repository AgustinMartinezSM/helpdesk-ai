-- AlterTable
ALTER TABLE "user_snapshots" ADD COLUMN     "organization_id" UUID;
...
UPDATE "user_snapshots" SET "organization_id" = '00000000-0000-4000-8000-000000000001' WHERE "organization_id" IS NULL;

-- CreateIndex: every dashboard aggregate now filters by tenant first.
CREATE INDEX "ticket_snapshots_organization_id_idx" ON "ticket_snapshots"("organization_id");

-- CreateIndex
CREATE INDEX "user_snapshots_organization_id_idx" ON "user_snapshots"("organization_id");
